...
public class Test_Vector : MonoBehaviour
{
    ...
    public Vector3 c = new Vector2(4, 5);
    ...
    void Update()
    {
        ...
        {       //스칼라 곱
            Debug.Log("기존에 있던 a(1, 2, 3)을 스칼라 곱 10을 해서 나온 값 = " + a * 10);
        }
        ...
        // 회전을 나타낼 땐 Quaternion을 사용한다. transform.rotation = new Quaternion(0, 0, 0, 1);     <= 4원수로 이루어진 것을 보여주기 위해 써놓은 것
